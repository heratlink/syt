...
const hospitalSetRedux = lazy(() => import("@pages/hospital/hospitalSetRedux"));
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "/syt/hospital/hospitalSetRedux",
            meta: {
              title: <Translation>route:hospitalSetRedux</Translation>,
            },
            element: load(hospitalSetRedux),
          },
          {
